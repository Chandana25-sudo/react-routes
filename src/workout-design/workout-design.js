    ...
    render() {
        return (
            <div className="Jogger-component">
                <div className="main">
                    <p name='calendar' className="date" >{this.state.date}</p>
                    <h7 name="date" className="day">{this.state.day}</h7>
                </div>   
                 ...
                 <i className="bi-arrow-right" id="right-arrow" style={{color:'rgb(76, 132, 236)'}}></i>
                    ...
                    <div className="nav-bars">
                        <a href="" className="hover-navbars">BEGINNER</a>
                        <a href="" className="hover-navbars">ADVANCED</a>
                        <a href="" className="hover-navbars">EXPERT</a>
                    </div>
